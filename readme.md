...
Pepper target detection dataset in YOLO format

Totally 2307 images, labeled and divided into training set, test set, validation set.

It is divided into 1 class, which are poppy, poppy.
